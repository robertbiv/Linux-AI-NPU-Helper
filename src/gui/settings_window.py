...
if _HAS_QT:
    ...
    def _security_tab(manager: Any) -> tuple[QWidget, list[_Field]]:
        ...
        allow_ext.setAccessibleName("Allow AI backend to contact external (non-local) servers")
    ...
    def _appearance_tab(manager: Any) -> tuple[QWidget, list[_Field]]:
        ...
        auto_send_screen.setAccessibleName("Automatically send screen on conversation page")
